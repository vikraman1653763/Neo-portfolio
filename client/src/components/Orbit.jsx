...
/** OrbitLayer as you already have it … (unchanged) */
function OrbitLayer({
  radius = 90,
  duration = 18,
  reverse = false,
...
export default function Orbit() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[600px] aspect-square overflow-visible">
      {/* Center programmer illustration */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        {/* Light mode logo */}
        <img
          src="/assets/programmer.svg"
          alt="Programmer"
          className="block dark:hidden w-15 h-15 object-contain"
        />
        {/* Dark mode logo */}
        <img
          src="/assets/programmer-white.svg"
          alt="Programmer white"
